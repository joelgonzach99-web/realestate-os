const NAV = [
  ...
  { id: 'nuevo_lead',  label: 'Nuevo Lead',    icon: '✦' },
    ...
    <aside style={styles.sidebar}>
      ...
      <div style={styles.brand}>
        <div style={styles.brandLogo}>
          <span style={styles.logoRE}>RE</span>
          <span style={styles.logoOS}>OS</span>
        </div>
        <div style={styles.brandSub}>MIAMI REALTY</div>
        <div style={styles.brandAgents}>JOEL + DAHIANA</div>
      </div>
      ...
      <div style={styles.footer}>
        ...
        <span style={styles.footerText}>SISTEMA ACTIVO</span>
      </div>
    </aside>
  )
}
